...
#----to grab a snapshot.... delete this---#
print("-----------------------------------------------")
print("-----------------------------------------------")
print("-----------------------------------------------")
print("-----------------------------------------------")
print("TOTALS")
print(f'Total core competencies:  350')
print(f'Current points achieved:  1374')
print(f'Total possible points:    21733')
print(f'Total percentage:         6.32%')
print("-----------------------------------------------")
print("-----------------------------------------------")